...
input_directory = os.path.abspath(os.path.join(
    os.getcwd(), os.pardir, os.pardir, 'big_data_input', 'Graticule'))
...
temp_directory = os.path.join(temp_directory, 'Graticule')
if not os.path.isdir(temp_directory): os.mkdir(temp_directory)
...
output_directory = os.path.join(output_directory, 'Graticule')
if not os.path.isdir(output_directory): os.mkdir(output_directory)
...
if os.path.exists(os.path.join(temp_directory, cropped_filename)):
...
xslice = 80 # choose slice along x for display
...
image_directory = os.path.abspath(os.path.join(
    os.getcwd(), os.pardir, os.pardir, 'master', 'images', 'Graticule'))
