...
input_directory = os.path.abspath(os.path.join(
    os.getcwd(), os.pardir, os.pardir, 'big_data_input', 'Paramecium'))
...
temp_directory = os.path.join(temp_directory, 'Paramecium')
if not os.path.isdir(temp_directory): os.mkdir(temp_directory)
...
output_directory = os.path.join(output_directory, 'Paramecium')
if not os.path.isdir(output_directory): os.mkdir(output_directory)
...
num_tps = 30 # Number of volumes or time points in series
