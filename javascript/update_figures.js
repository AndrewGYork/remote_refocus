...
function update_figure_1() {
  ...
  if ((choice === "DIC")){
  var filename = big_data_output + "/Worm DIC/figure.mp4";
  var postername = big_data_output + "/Worm DIC/poster.png";}
  if ((choice === "TLFL")){
  var filename = big_data_output + "/Worm TL FL/figure.mp4";
  var postername = big_data_output + "/Worm TL FL/poster.png";}  
...
function update_figure_5() {
  ...
  var filename = big_data_output + "/SIM target/img" + microscope + RR + ".png";
...
function update_figure_9() {
  ...
  if ((choice === "3color")){
  var filename = big_data_output + "/Yeast 3 color/figure.mp4";
  var postername = big_data_output + "/Yeast 3 color/poster.png";}
  if ((choice === "2color")){
  var filename = big_data_output + "/Yeast 2 color/figure.mp4";
  var postername = big_data_output + "/Yeast 2 color/poster.png";}  
  if ((choice === "amoeba")){
  ...
  if ((choice === "food")){
  var filename = big_data_output + "/Spirostomum food/figure.mp4";
  var postername = big_data_output + "/Spirostomum food/poster.png";}
  if ((choice === "flower")){
  var filename = big_data_output + "/Spirostomum flower/figure.mp4";
  var postername = big_data_output + "/Spirostomum flower/poster.png";}
...
function update_afigure_4() {
  ...
  if ((choice === "0.1umRR")){
  var filename = "./images/PI/Step response - RR piezo for 0.1um - 10ms.png";} 
  if ((choice === "0.5umRR")){
  var filename = "./images/PI/Step response - RR piezo for 0.5um - 10ms.png";}  
  if ((choice === "1.0umRR")){
  var filename = "./images/PI/Step response - RR piezo for 1um - 10ms.png";}
  if ((choice === "15umRR")){
  var filename = "./images/PI/Step response - RR piezo for 15um - 15ms.png";}
  if ((choice === "10umInsert")){
  var filename = "./images/PI/Step response - Z piezo insert for 10um - 50ms.png";}
